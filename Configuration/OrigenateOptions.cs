...
public sealed class OrigenateOptions
{
    ...
    public string DeadLetterQueueName { get; set; } = "origenate-dead-letter";
    public string ErrorArchiveContainerName { get; set; } = "origenate-error-archive";

    // Overridden at startup from host.json's extensions.queues.maxDequeueCount so
    // the runtime's actual requeue count and this value never drift. See Program.cs
    // ReadHostJsonMaxDequeueCount.
